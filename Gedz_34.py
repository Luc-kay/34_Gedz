...
def registration_form():
    ...
    caption = Label(text="Регистрация", font=("Arial", 14),
                    background="#C4EBBE", foreground="#545863")
    ...
    button_registration = Button(ak, text="Регистрация", background="#3FAF8C", foreground="#FFF", font=(
...
caption = Label(text="Вход", font=("Arial", 14),
                background="#C4EBBE", foreground="#545863")
...
button_entrance = Button(tk, text="Вход",  background="#3FAF8C", foreground="#FFF", font=(
    "Arial", 12, "bold"), border=0, command=lambda: test())
button_entrance.place(x=200, y=270, height=30, width=230,
                      anchor="c", bordermode=OUTSIDE)

button_registration_main = Button(tk, text="Регистрация", background="#2FAF8C",
...
ismarried_checkbutton = Checkbutton(text="Запомнить пароль", font=(
    "Arial", 12),  foreground="#545863", background="#C4EBBE", variable=ismarried)
...
text_enter_password = Label(text="Забыли пароль?", font=(
    "Arial", 12), background="#C4EBBE", foreground="#545863")
